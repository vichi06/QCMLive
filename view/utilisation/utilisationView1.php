...
<section id="tuto"> 
  ...
  <div class="container">
    <div class="jumbotron wow bounceInDown"style="background-color:#F0F1F7">
      <div class="container">
        ...
        <p class="lead">Prenez le temps de comprendre.</p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-7">
        <a href="#">
         ...
         <img class="img-fluid rounded mb-3 mb-md-0 animated wow fadeIn" src="./public/images/tuto1.jpg" alt="">
       </a>
     </div>
     <div class="col-md-5">
      <h3>Accueil</h3>
  ...
  <div class="row">
    <div class="col-md-7">
      <a href="#">
        <img class="img-fluid rounded mb-3 mb-md-0 animated wow fadeIn " src="./public/images/tuto2.jpg" alt="">
      </a>
    </div>
    <div class="col-md-5">
      <h3>Login</h3>
    ...
    <div class="row">
      <div class="col-md-7">
        <a href="#">
          <img class="img-fluid rounded mb-3 mb-md-0 wow fadeIn" src="./public/images/tuto4.jpg" alt="">
        </a>
      </div>
      <div class="col-md-5">
        <h3>Menu</h3>
