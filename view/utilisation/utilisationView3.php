		...
		<div class="container">
			<div class="jumbotron wow bounceInDown"style="background-color:#F0F1F7">
				<div class="container">
					...
					<p class="lead">Prenez le temps de comprendre.<br><strong><u>En tant que professeur.</strong></u></p>
				</div>
			</div>
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination pg-blue justify-content-center">
					<li class="page-item">
						<a class="page-link" href="./index?action=pageUtilisation2" aria-label="Previous">
